...
makedocs(;
    ...
    repo="https://github.com/MultivariatePolynomialSystems/AlgebraicVision.jl/blob/{commit}{path}#{line}",
...
deploydocs(;
    repo="github.com/MultivariatePolynomialSystems/AlgebraicVision.jl",
    devbranch="main",
)
